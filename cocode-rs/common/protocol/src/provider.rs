...
//!
//! This module defines the complete runtime api for providers:
//! - `ProviderApi`: Provider api enumeration
...
pub struct ProviderInfo {
    ...
    /// Provider API type for selecting implementation.
    #[serde(rename = "api")]
    pub api: ProviderApi,
...
impl ProviderInfo {
    ...
    pub fn new(name: impl Into<String>, api: ProviderApi, base_url: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            api,
