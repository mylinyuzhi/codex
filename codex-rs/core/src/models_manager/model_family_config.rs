//! Configurable model family definitions that can be loaded from TOML.
//!
//! This module allows users to define custom model families in `~/.codex/model_families.toml`
//! instead of relying solely on code-defined families.
...
/// Configurable model family definition.
///
/// Users can define custom model families in `~/.codex/model_families.toml`:
///
/// ```toml
/// [deepseek-r1]
...
mod tests {
    ...
    fn test_deserialize_from_toml() {
        ...
        let config: ModelFamilyConfig = toml::from_str(toml_str).unwrap();
