//! cocode-inference - LLM inference orchestration layer for the agent system.
//!
...
pub use thinking_convert::effort_to_reasoning_level;
...
// Version-free aliases: downstream crates import these names from cocode_inference.
