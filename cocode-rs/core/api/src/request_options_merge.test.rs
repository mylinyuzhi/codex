...
fn test_provider_base_options_openai() {
    let opts = provider_base_options(ProviderType::Openai).expect("OpenAI should have base opts");
...
fn test_provider_base_options_openai_compat() {
    let opts = provider_base_options(ProviderType::OpenaiCompat)
...
fn test_provider_base_options_gemini() {
    let opts = provider_base_options(ProviderType::Gemini).expect("Gemini should have base opts");
...
fn test_provider_base_options_anthropic_none() {
    assert!(provider_base_options(ProviderType::Anthropic).is_none());
}

#[test]
fn test_provider_base_options_volcengine_none() {
    assert!(provider_base_options(ProviderType::Volcengine).is_none());
}

#[test]
fn test_provider_base_options_zai_none() {
    assert!(provider_base_options(ProviderType::Zai).is_none());
}
