...
Skipped until Phase 2.A.5 regenerates protocol.py from coco-rs.
"""

import pytest

pytest.skip(
    "Pending Phase 2.A.5 schema regeneration — current protocol.py is the "
    "partial set inherited from cocode-sdk and lacks HookCallbackOutput, "
    "PostToolUseHookInput, PreToolUseHookInput, SessionEndedReason.",
    allow_module_level=True,
)

import coco_sdk  # noqa: E402
from coco_sdk.generated.protocol import (  # noqa: E402
    HookBehavior,
    HookCallbackOutput,
...
def test_all_exports_importable():
    ...
    for name in coco_sdk.__all__:
        assert hasattr(coco_sdk, name), f"{name} listed in __all__ but not importable"
