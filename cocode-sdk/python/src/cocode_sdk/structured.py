...
``structured_output`` from ``session/result`` back into the model::
    ...
    from cocode_sdk import TypedClient
...
from cocode_sdk.generated.protocol import SessionResultParams

T = TypeVar("T", bound=BaseModel)


class TypedClient(CocodeClient, Generic[T]):
    """CocodeClient that produces typed structured output."""
