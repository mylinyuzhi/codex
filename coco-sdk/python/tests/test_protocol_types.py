...
pytest.skip(
    "Tests reference old cocode-sdk protocol types (HookBehavior, "
    "HookCallbackOutput, PostToolUseHookInput, PreToolUseHookInput, "
    "CommandExecutionItem, Usage with specific fields). Pending coco-rs "
    "schema emission of these types. See PORT_STATUS.md.",
