use super::*;
use vercel_ai_provider::language_model_middleware::{MiddlewareOptions, TransformParamsOptions, CallType};
...
impl vercel_ai_provider::LanguageModelV4 for MockModel {
    ...
    async fn do_generate(&self, _: LanguageModelV4CallOptions) -> Result<vercel_ai_provider::LanguageModelV4GenerateResult, AISdkError> { unimplemented!() }
    async fn do_stream(&self, _: LanguageModelV4CallOptions) -> Result<vercel_ai_provider::LanguageModelV4StreamResult, AISdkError> { unimplemented!() }
}