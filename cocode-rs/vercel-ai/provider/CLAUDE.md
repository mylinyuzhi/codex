...
This crate provides Rust type definitions matching `@ai-sdk/provider` v4 specification. It is a standalone types crate with no dependencies on other cocode crates.
...
1. **Standalone**: No dependencies on other cocode crates
