...
static ADAPTER_REGISTRY: LazyLock<AdapterRegistry> = LazyLock::new(|| {
    ...
    registry.register(Arc::new(super::gpt_openapi::GptAdapter::new()));
    registry.register(Arc::new(super::gpt_openapi::GeminiAdapter::new()));

    // Future: Add more custom adapters here as needed
