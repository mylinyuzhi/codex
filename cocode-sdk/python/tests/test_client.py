"""Tests for CocodeClient with a mock transport."""
...
def test_client_sends_session_start():
    ...
    async def run():
        client = CocodeClient(prompt="hello", transport=transport)
        await client.start()
        events = []
...
def test_client_send_follow_up():
    ...
    async def run():
        client = CocodeClient(prompt="init", transport=transport)
...
def test_client_auto_approval():
    ...
    async def run():
        client = CocodeClient(prompt="test", transport=transport, can_use_tool=auto_approve)
        client._started = True
        events = []
        async for event in client.events():
            events.append(event)
...
def test_client_interrupt():
    ...
    async def run():
        client = CocodeClient(prompt="test", transport=transport)
        client._started = True
...
def test_client_context_manager():
    ...
    async def run():
        async with CocodeClient(prompt="hi", transport=transport) as client:
            async for event in client.events():
                pass
