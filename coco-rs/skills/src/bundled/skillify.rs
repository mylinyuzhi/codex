...
You will use the __ASK_USER_QUESTION__ to understand what the user wants to automate. Important notes:
- Use __ASK_USER_QUESTION__ for ALL questions! Never ask questions via plain text.
...
You may do multiple rounds of __ASK_USER_QUESTION__ here, one round per step, especially if there are more than 3 steps or many clarification questions. Iterate as much as needed.
...
Before writing the file, output the complete SKILL.md content as a yaml code block in your response so the user can review it with proper syntax highlighting. Then ask for confirmation using __ASK_USER_QUESTION__ with a simple question like "Does this SKILL.md look good to save?" — do NOT use the body field, keep the question concise.
