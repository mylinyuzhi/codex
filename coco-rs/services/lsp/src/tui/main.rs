...
async fn main() -> Result<()> {
    ...
    let coco_home = coco_lsp::find_coco_home();

    // Initialize file-based logging to coco_home/log/lsp.log
    ...
    let logging_config = coco_utils_common::LoggingConfig {
        modules: vec![format!("coco_lsp={}", log_level)],
        ..Default::default()
    };
    ...
    // Create app state
    let mut app = App::new(coco_home, workspace, manager, diagnostics);
