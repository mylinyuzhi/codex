...
| Bucket | Total | Done |
|---|---:|---:|
| **P1** (wiring; small) | 18 | 0 |
| **P2** (parity tail) | 78 | 0 |
| **P3** (cosmetic/edge) | 58 | 0 |
| **Open total** | 155 | 0 |

● 140 genuinely open · ◑ 15 partially fixed · ✅ 46 already closed (reference only). By severity: **HIGH 12 (+3 misses) · MEDIUM 56 · LOW 84.**

## P1 — finish the half-wired subsystems (small effort, mostly wiring)

### [ ] mcp · short_request_id
...
### [ ] plugins#231 — Enterprise plugin policy never read from managed settings; no per-plugin blockl…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound_with_caveats*
...
### [ ] skills#195 — App loads only 2 flat skill dirs - managed/legacy-commands/project-up-to-home/d…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound_with_caveats*
...
### [ ] commands#204 — /help is a hardcoded category list advertising nonexistent commands and wrong a…
...
### [ ] commands#206 — /clear missing reset/new aliases; /config alias is 'configuration' not TS 'sett…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] memory#224 — SessionMemory first (init) extraction skips the tool-call/natural-break gate TS…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] skills#198 — No resetSentSkillNames analogue - reloaded skills with same names are never re-…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] skills#200 — Manual /reload-plugins never updates the model-facing SkillManager - only the /…
...
### [ ] skills#201 — Bootstrap loads .coco/skills but not .claude/skills for the model - TS-compat p…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] memory#225 — SessionMemory 'initialized' latch flips on successful fork, not on threshold cr…
...
### [ ] tools-file#19 — NotebookEdit drops replace->insert-past-end conversion and cell_type change on …
...
### [ ] tools-file#20 — NotebookEdit insert silently defaults cell_type instead of erroring (errorCode …
`● genuinely_open` · **LOW** · effort **trivial** · fix-sketch *sound*
...
### [ ] tools-file#24 — Read does not validate pages param up-front; open-ended and over-limit ranges d…
...
### [ ] tools-file#29 — NotebookEdit validate_input never runs; .ipynb extension/cell-not-found checks …
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] system-reminder#109 — Queued commands may double-inject: live drain path + reminder generator both re…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] system-reminder#110 — count_human_turns is whole-history monotonic, never reset per-turn — mechanism …
...
### [ ] tool-runtime#10 — Level 2 per-message budget total counts opted-out (Read) and already-replaced r…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] tool-runtime#12 — User-interrupt cancelled tool result uses 'Error: cancelled' instead of TS inte…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] config#243 — available_models allowlist matching is a naive substring check, not enforced, w…
`● genuinely_open` · **MEDI** · effort **medium** · fix-sketch *sound*
...
### [ ] config#253 — validate_settings (and its entire validation suite) has zero production consume…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] context#98 — File checkpointing default-on for non-interactive sessions; TS env overrides ab…
`● genuinely_open` · **MEDI** · effort **medium** · fix-sketch *sound*
...
### [ ] messages#81 — No strip of problematic document/image blocks after PDF/image/request-too-large…
`● genuinely_open` · **MEDI** · effort **medium** · fix-sketch *sound*
...
### [ ] messages#82 — local_command system messages are dropped from the API prompt instead of becomi…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] messages#83 — merge_consecutive_user_messages omits joinTextAtSeam newline, concatenating adj…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] subagent#120 — Classifier-unavailable handoff warning (UNAVAILABLE_WARNING) is never surfaced …
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] tools-web-mcp#52 — Preapproved-host bypass for WebFetch is dead code (never consulted by the permi…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound_with_caveats*
...
### [ ] mcp#151 — ElicitationComplete notification dismisses any prompt instead of matching elici…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] permissions#68 — Classifier transcript includes assistant-authored text (TS excludes it for prom…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound*
...
### [ ] skills#194 — Skill change watcher is defined but never instantiated by the app - no hot relo…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound_with_caveats*
...
### [ ] tools-agent-task#44 — Standalone EnterWorktree/ExitWorktree tools use a different schema and skip all…
`◑ partially_fixed` · **HIGH** · effort **small** · fix-sketch *sound_with_caveats*
...
### [ ] coordinator#265 — External (outside-tmux) teammate panes get no border color, no pane-border-stat…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] hooks#190 — Malformed/invalid hook JSON is silently injected as additional context instead …
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] inference#133 — No foreground/background query-source gating for 529 retries (capacity-cascade …
`● genuinely_open` · **MEDI** · effort **medium** · fix-sketch *sound*
...
### [ ] inference#134 — Default retry count/base-delay diverge from TS (3/1000ms vs 10/500ms); no max-r…
`◑ partially_fixed` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] plugins#234 — MCPB config validation only checks 'required'; no type/range checks or sensitiv…
`● genuinely_open` · **MEDI** · effort **medium** · fix-sketch *sound*
...
`● genuinely_open` · **MEDI** · effort **large** · fix-sketch *sound*
...
### [ ] plugins#240 — Slash-command /plugin enable/disable use a separate disabled_plugins.json, divo…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] query#3 — Later-priority task notifications drain every turn instead of only after a Slee…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] sandbox#177 — Sandbox hot-reload + bootstrap subscriber only wired on TUI path, not SDK/print…
...
### [ ] skills#196 — Skill listing drops skills under budget pressure instead of truncating; live mo…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] tools-agent-task#48 — BriefTool accepts non-existent / inaccessible attachment paths instead of rejec…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] tools-exec#34 — Output truncation keeps head+tail instead of TS head-only, with a different mar…
`● genuinely_open` · **MEDI** · effort **small** · fix-sketch *sound*
...
### [ ] commands#209 — /compact ignores COCO_COMPACT_DISABLE for command visibility (TS hides it via i…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] permissions#75 — No 'tool declares no classifier-relevant input' short-circuit; format_action di…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] permissions#78 — Consecutive-denial counter is never reset on rule/hook-allowed tools in auto mo…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] shell#164 — acceptEdits auto-allow checks only the first base command, not each subcommand …
`● genuinely_open` · **LOW** · effort **medium** · fix-sketch *sound*
...
### [ ] shell#167 — git-commit-substitution / dangerous-variables / incomplete-command early valida…
`● genuinely_open` · **LOW** · effort **medium** · fix-sketch *sound*
...
### [ ] skills#197 — Dynamically discovered nested .claude/skills dirs are loaded without the gitign…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
...
### [ ] tasks#213 — Verification-agent nudge drops the TS feature('VERIFICATION_AGENT') and tengu_h…
`● genuinely_open` · **LOW** · effort **small** · fix-sketch *sound*
